...
export default function About() {
  return (
    <section id="about" className="relative overflow-hidden bg-black py-20 md:py-32" data-testid="about-section">
        ...
        <div className="grid lg:grid-cols-12 gap-8 md:gap-10 items-center">
          ...
          >
            <div className="max-w-4xl">
              <p className="text-zinc-100 text-4xl md:text-5xl lg:text-7xl font-display font-black uppercase tracking-tighter leading-[0.9]">
                Websites,<br />
                <span className="text-stroke">brands & motion</span>
              </p>
              <p className="mt-8 max-w-2xl text-zinc-300 text-xl md:text-2xl font-light leading-relaxed">
          ...
          >
            <div className="group relative overflow-hidden rounded-[2rem] border border-white/15 p-4 md:p-6 bg-white/5 shadow-[0_0_80px_rgba(0,0,0,0.25)] transition-all duration-500 ease-out hover:bg-white/95">
        ...
        <div className="mt-12 md:mt-16 grid md:grid-cols-3 gap-px bg-white/10 border border-white/10">
          {metrics.map((metric, index) => (
            <motion.div
              ...
              className="group min-h-44 p-6 md:p-8 bg-black text-white flex flex-col items-center justify-center text-center transition-colors"
            >
              <motion.div
                initial={{ scale: 0.9 }}
                whileInView={{ scale: 1 }}
