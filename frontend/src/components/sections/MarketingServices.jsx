        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {marketingServices.map((service, index) => (
              <motion.button
                ...
                className="group relative overflow-hidden border border-white/10 bg-black/70 p-4 text-left transition-colors hover:border-white/25 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-white/70 focus-visible:ring-offset-4 focus-visible:ring-offset-black"
                ...
                <div className="relative flex min-h-[520px] flex-col">
                  <div className="relative aspect-[4/3] overflow-hidden border border-white/10 bg-white/[0.03]">
                    <motion.img
                      src={service.image}
                      alt=""
                      className="h-full w-full object-cover grayscale contrast-125 opacity-75 transition-all duration-700 group-hover:grayscale-0 group-hover:contrast-100 group-hover:opacity-100"
                      initial={false}
                  ...
                  <div className="flex flex-1 flex-col justify-between px-2 pb-2 pt-7">
                    <div>
                      <h3 className="font-display font-black text-3xl md:text-4xl tracking-tighter leading-[0.95]">
                        {service.title}
                      </h3>
            ...
            >
              ...
              <div className="relative grid h-full min-h-0 md:grid-cols-12">
                <div className="md:col-span-5 border-b md:border-b-0 md:border-r border-white/10 p-6 md:p-8 lg:p-10 flex min-h-0 flex-col gap-8">
                  <div>
                    <p className="text-xs tracking-[0.28em] uppercase text-zinc-500 font-bold font-mono">/ Marketing {active.n}</p>
                  </div>
                  ...
                  <div>
                    <h3 id="marketing-modal-title" className="font-display font-black text-4xl sm:text-5xl lg:text-6xl tracking-tighter leading-[0.92] mt-6">
                      {active.title}
                    </h3>
