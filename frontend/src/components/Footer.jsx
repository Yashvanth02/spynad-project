export default function Footer() {
  return (
    <footer className="border-t border-white/10 bg-black" data-testid="footer">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-12 lg:px-16 py-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 items-start">
        <div className="sm:col-span-2">
          <div className="flex items-start">
            <img src="/SPYNAD logo.png" alt="Spynad logo" className="h-24 w-24 sm:h-[126px] sm:w-[126px] object-contain sm:-mt-8" />
          </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-zinc-300">
            <li><a href="mailto:spynadmarketing@gmail.com" className="break-all hover:text-white">spynadmarketing@gmail.com</a></li>
            <li><a href="#contact" className="text-white font-semibold hover:text-zinc-100">Contact Us</a></li>
          </ul>
        </div>
      </div>
      <div className="border-t border-white/5">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-12 lg:px-16 py-4 flex flex-col md:flex-row justify-between items-start sm:items-center gap-3 text-xs text-zinc-600">
